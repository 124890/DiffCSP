...
class GemNetT(torch.nn.Module):
    ...
    def generate_interaction_graph(self, cart_coords, lengths, angles,
        ...
        bs_non_zero = block_sizes > 0
        block_sizes = torch.masked_select(block_sizes, bs_non_zero)
    ...
    def forward(self, z, frac_coords, atom_types, num_atoms, lengths, angles,
                edge_index, to_jimages, num_bonds, lattices = None):
        """
        args:
        ...
        """
        pos = frac_to_cart_coords(frac_coords, lengths, angles, num_atoms, lattices = lattices)
